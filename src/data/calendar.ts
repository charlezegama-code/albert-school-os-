...
export const OFFICIAL_EVENTS: CalendarEvent[] = [
  ...
  { id: 'o14', title: 'Vacances',          type: 'VACANCES', startDate: '2027-02-22', endDate: '2027-02-26' },
...
export const EVENT_BG: Record<EventType, string> = {
  COURS:    'rgba(14,165,233,0.15)',
  BDD:      'rgba(245,158,11,0.15)',
  EXAMEN:   'rgba(239,68,68,0.15)',
  DEVOIR:   'rgba(139,92,246,0.15)',
  PERSO:    'rgba(100,116,139,0.15)',
  VACANCES: 'rgba(16,185,129,0.15)',
}
